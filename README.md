...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/qh8KdhSXFe)
...
```sh
npx nx serve performance-team
```

To create a production bundle:

```sh
npx nx build performance-team
```

To see all available targets to run for a project, run:

```sh
npx nx show project performance-team
```
